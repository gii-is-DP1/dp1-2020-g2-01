...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/vehiculos/listadoVehiculos").hasAnyAuthority("admin", "cliente")
				.antMatchers("/vehiculos/**").hasAnyAuthority("admin", "cliente")
				...
				.antMatchers("/clientes/listadoClientes").hasAnyAuthority("admin")
				...
				.antMatchers("/clientes/clienteDetails/*").hasAnyAuthority("cliente","admin")
				.antMatchers("/clientes/clienteDetails").hasAnyAuthority("cliente","admin")
				...
				.antMatchers("/recambios/solicitud/new").hasAnyAuthority("empleado")
