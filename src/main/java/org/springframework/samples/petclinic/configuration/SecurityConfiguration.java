...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/citas/eliminarCitasCovid").hasAnyAuthority("admin")
				.antMatchers("/citas/atender/**").hasAnyAuthority("empleado", "admin")
				.antMatchers("/citas/noAtender/**").hasAnyAuthority("admin", "empleado")
