...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/reparaciones/getReparacion/**").hasAnyAuthority("admin", "empleado", "cliente")
				...
				.antMatchers("/clientes/clienteDetails/*").permitAll()
				.antMatchers("/clientes/clienteDetails").permitAll()
				.antMatchers("/clientes/update/*").hasAnyAuthority("cliente")
				.antMatchers("/reparacionesComunes/**").hasAnyAuthority("admin", "empleado")
				.antMatchers("/citas/new").hasAnyAuthority("cliente")
				.antMatchers("/citas/new/**").hasAnyAuthority("empleado","admin")
				.antMatchers("/citas/covid/**").hasAnyAuthority("admin")
				...
				.antMatchers("/facturaRecambio/**").hasAnyAuthority("admin")
				.anyRequest().denyAll()
				.and()
				 	.formLogin()
				 	/*.loginPage("/login")*/
