...
<petclinic:layout pageName="vehiculos">
    ...
    <br>
    <div class="cita" align="center">
    	<h4><strong>¿Está seguro de que desea borrar la cita?</strong></h4>
    	
    	<spring:url value="/citas/delete/{citaId}" var="citaUrl">
    					<spring:param name="citaId" value="${id}"/>
    	</spring:url>
    	<br>		
    	<a href="${fn:escapeXml(citaUrl)}" class="btn btn-success btn-lg" role="button">Sí, estoy seguro</a>
