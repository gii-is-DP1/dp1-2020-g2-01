...
<petclinic:layout pageName="recoger">
    <br>
    
    <div class="reparacion" align="center">
    	<h4><strong>¿Está seguro de que desea dar por recogida esta reparación?</strong></h4>
    	<h5>Se sobreescribirá la fecha de recogida de esta reparación.</h5>
    	<br>
    	
    	<spring:url value="/reparaciones/recogerReparacion/{reparacionId}" var="reparacionUrl">
